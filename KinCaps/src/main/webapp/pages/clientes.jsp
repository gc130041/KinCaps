                    ...
                    <table class="table table-striped table-bordered align-middle text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>cr@gmail.com</td>
                                <td>+502 2345-6789</td>
                                <td>Zona 1, Capital Guatemal</td>
                                <td class="grap-text">1234567890qwertyuiopasdfghjklñ1234567890qwertyuiopasdfghjklñ1234</td>
                                <td>
                                    <button style="font-size: 10px;" class="btn btn-sm btn-edit">Activar</button>
                                    <button style="font-size: 10px;" class="btn btn-sm btn-delete">Desactivar</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
