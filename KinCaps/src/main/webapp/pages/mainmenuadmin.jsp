                ...
                <div class="row justify-content-center g-4">
                    <div class="col-md-4">
                        <div class="card option-card h-100 text-center p-4">
                            ...
                            <a href="proveedor.jsp" class="btn menu-button mt-2">Gestionar Proveedores</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card option-card h-100 text-center p-4">
                            ...
                            <a href="clientes.jsp" class="btn menu-button mt-2">Gestionar Usuarios</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card option-card h-100 text-center p-4">
                    ...
                    <div class="col-md-4">
                        <div class="card option-card h-100 text-center p-4">
                            ...
                            <a href="carrito.jsp" class="btn menu-button mt-2">Ver Carrito</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card option-card h-100 text-center p-4">
                            ...
                            <a href="factura.jsp" class="btn menu-button mt-2">Gestionar Facturas</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card option-card h-100 text-center p-4">
                            ...
                            <a href="detalleFactura.jsp" class="btn menu-button mt-2">Ver Detalle</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card option-card h-100 text-center p-4">
                            ...
                            <a href="detalleCarrito.jsp" class="btn menu-button mt-2">Ver Detalle</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card option-card h-100 text-center p-4">
