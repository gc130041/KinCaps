...
<html>
    ...
    <body class="d-flex flex-column min-vh-100" style='margin-right:0%'>
        <main class="flex-grow-1 p-3" style="overflow-y: auto; padding-top: 70px;">
            <div class="container-fluid">
                <!-- Navbar -->
                <nav class="navbar navbar-expand-lg bg-header navbar-dark fixed-top" style="z-index: 1000;">
                    <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-12 mb-4">
                        <div class="filtro-seccion bg-light p-3 rounded shadow-sm" style="width: 100%; max-width: 300px;">
                            <h2 class="h4">Filtro de Búsqueda</h2>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-12">
                        <div class="row justify-content-start" style="margin-top: 20px;">
                            <!-- Gorra -->
                            <div class="col-sm-6 col-md-4 col-lg-3 mb-4" style="width: 30vh; height: 40vh;">
                                <div class="card h-100 shadow-sm">
                                    <span class="insignia-tipo tipo-NY">
                                        <img src="${pageContext.request.contextPath}/img/NY_logo_white.png" alt="New Era" style="width: 35px;">
                                    </span>
                                    <img src="${pageContext.request.contextPath}/img/Gorras/Urbanos/gorra1.png" class="card-img-top" alt="gorra1" style="object-fit: cover; height: 60%; width: 100%; object-position: center;">
                                    <div class="card-body text-center" style="height: 40%; display: flex; flex-direction: column; justify-content: space-between; padding: 10px;">
                                        <h5 class="card-title" style="font-size: 1rem; margin-bottom: 0.5rem;">Gorra Urbanos</h5>
                                        <p class="card-text text-muted" style="font-size: 0.9rem; margin-bottom: 0.5rem;">Gorra New Era Azul de Los Angeles Dodgers, Año 1988.</p>
                                        <a href="#" class="btn btn-outline-primary" style="font-size: 0.8rem; padding: 0.5rem 1rem; border-radius: 5px;">Ver más</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-3 mb-4" style="width: 30vh; height: 40vh;">
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <img src="${pageContext.request.contextPath}/img/Gorras/Urbanos/gorra2.png" class="card-img-top" alt="gorra2" style="object-fit: cover; height: 60%; width: 100%; object-position: center;">
                                    <div class="card-body text-center" style="height: 40%; display: flex; flex-direction: column; justify-content: space-between; padding: 10px;">
                                        <h5 class="card-title" style="font-size: 1rem; margin-bottom: 0.5rem;">Gorra Urbanos</h5>
                                        <p class="card-text text-muted" style="font-size: 0.9rem; margin-bottom: 0.5rem;">Gorra New Era Azul de Los Angeles Dodgers, Año 1988.</p>
                                        <a href="#" class="btn btn-outline-primary" style="font-size: 0.8rem; padding: 0.5rem 1rem; border-radius: 5px;">Ver más</a>
